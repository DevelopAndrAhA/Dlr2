...
<div class=row>
    <TABLE class="table table-striped">
        <TR>
            <TH></TH><TH>Общ. сумма заказа(сом)</TH><TH>Дата заказа</TH><TH>Статус</TH><TH></TH>
        </TR>
<%
    List<MyOrder> myOrders  =(List<MyOrder>) ctx.getAttribute("myOrders");
     for(int i =0;i<myOrders.size();i++){
            ...
            out.print("<TD><INPUT style='display:none' TYPE=checkbox id='check"+i+"'></TD><TD style='display:none' id='orderId"+i+"'>"
                    ...
                    "</TD><TD><a href=detailsCompletedOrder?order="
                    +myOrders.get(i).getId()+
            ...
            <%
                if(sizeToPagination!=0){
                    ...
                    if(pagesEnd){
                        ...
                        for(int k=1;k<=sizeToPagination;k++){
                            if(activePageNumber==k){
                                ...
                                out.print("<a class=page-link href=complete_orders_p?page="+k+" tabindex=-1>"+k+"</a>");
                                out.print("</li>");
                            }else{
                    ...
                    if(activePageNumber<sizeToPagination){
                        ...
                        out.print("<a class=page-link href=complete_orders_p?page="+nextpage+" tabindex=-1>След.</a>");
                        out.print("</li>");
                    }else{
