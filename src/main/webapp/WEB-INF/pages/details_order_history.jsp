...
<head>
  ...
  <link rel="stylesheet"  href="resources/css/mycss/details_order_history.css" />
...
<div class=container>
    ...
    <TABLE class="table table-striped">
        <TR>
            <TH>Название</TH> <TH>Цена(сом)</TH><TH>Объем</TH><TH>Кол/ство</TH><TH>В долг</TH>
        </TR>
<%
    ...
    for(int i =0;i<productsList.size();i++){
        ...
        out.print("<TR>");
        out.print("<TD id='productId"+i+"' style='display:none'>"+products.getId()+"</TD><TD id='sumId"+i+"'>"+products.getName()+"</TD><TD id='dateId"+i+"'>"+products.getPrice()+"</TD><TD id='dateId"+i+"'>"+products.getWeight()+"</TD><TD id='dateId"+i+"'>"+products.getAmount()+"</TD><TD><img src=/resources/images/"+nameImg+".png></TD>");
        out.print("</TR>");
...
%>
        ...
        <%
            out.print("<div class='row shop_div' >");
            out.print("<div>");
            out.print("<p>Магазин(заказчик)</p>");
            try{
                out.print("<img src=photo_shops?imgName="+myOrder.getShops().getPhoto()+"  ><br>");
            ...
            out.print("</div>");
            out.print("</div>");
            out.print("<div class='row courier_div' >");
            out.print("<div>");
